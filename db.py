...
FIELDS = (
    ["uid", "name", "name_changed", "clan",
     ...
     "chest_common", "chest_rare", "chest_legend",
     "legend_chest_smith", "legend_chest_armorer", "legend_chest_jeweler",
     "legend_chest_alchemist", "legend_chest_miner",
...
def _build_create_sql():
    parts = [
        ...
        "chest_common INTEGER DEFAULT 0",
        "chest_rare INTEGER DEFAULT 0",
        "chest_legend INTEGER DEFAULT 0",
        "legend_chest_smith INTEGER DEFAULT 0",
        "legend_chest_armorer INTEGER DEFAULT 0",
...
def get_player(uid, name="Игрок"):
    ...
    defaults = {
        ...
        "crafted_items": "[]", "inventory_items": "[]", "pet_data": "[]",
        "chest_common": 0, "chest_rare": 0, "chest_legend": 0,
        "legend_chest_smith": 0, "legend_chest_armorer": 0,
        "legend_chest_jeweler": 0, "legend_chest_alchemist": 0,
        "legend_chest_miner": 0,
